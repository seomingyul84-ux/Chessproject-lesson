// lessons.js 파일 내용 (좌표 테스트 추가 및 전체 단계 번호 조정)
...
const LESSON_DATA = [
    {
        ...
        steps: [
            ...
            // 2단계: 좌표 퀴즈 (새로 추가됨)
            {
                ...
                description: `<p>체스보드에서 좌표 읽기를 연습해 봅시다. E2 폰을 움직여 좌표 **e4** 칸으로 이동시키세요. (e:파일, 4:랭크)</p>`,
            ...
            // 13단계: 퀸과 킹의 행마 (이론) (원래 12단계)
            {
                ...
                description: `
                    ...
                    <p>킹 (King, K): 퀸의 행마법을 한 칸씩으로 제한시킨 행마법입니다. 킹이 잡히면 게임이 끝납!</p>
                `,
                hint: '퀸은 모든 방향으로 이동 가능하며, 킹은 안전이 최우선입니다.',
            },

            // 14단계: 특수 규칙 1: 프로모션 - 퍼즐 (원래 13단계)
            {
                stepId: '2.1',
            ...
            // 16단계: 특수 규칙 3: 캐슬링 - 퍼즐 (킹사이드) (원래 15단계)
            {
                stepId: '2.3.1',
            ...
            // 17단계: 특수 규칙 3: 캐슬링 - 퍼즐 (퀸사이드) (원래 16단계)
            {
                stepId: '2.3.2',
            ...
            // 19단계: 용어 정리 (2) - 전략 및 평가 용어 (이론) (원래 18단계)
            {
                stepId: '1.0.3.B',
