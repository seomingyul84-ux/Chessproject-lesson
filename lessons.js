    ...
    // =========================================
    {
        ...
        steps: [
            ...
            // 10단계: 나이트의 행마 (예시 1)
            {
                ...
                description: `<p>나이트는 L자 모양으로 움직입니다. 아니면 좌/우/앞/뒤로 2칸, 그 다음에 좌/우로 1칸 갈 수 있죠. 예시로 지금 D2에 있는 나이트를 앞으로 2칸,왼쪽으로 1칸 가면 c4로 이동할 수 있습니다. 하지만 우리는 그러지 않을 겁니다. D2에 있는 나이트를 F3으로 이동시켜 보세요.</p>`,
            ...
            {
                stepId: '1.3.1',
                title: "13단계 (1): 비숍 (Bishop, B, 3점) - 어두운 칸 대각선 끝까지",
            ...
            // 19단계: 특수 규칙 1: 프로모션 - 퍼즐
            {
                ...
                description: `<p>폰이 반대편 끝(8랭크)에 도달하면 승격(프로모션)합니다. A7 폰을 움직여 프로모션을 시도해 보세요. (원래는 룩, 비숍, 나이트, 퀸 모두 승격 가능하지만 이번에는 자동으로 퀸으로 승격됩니다. 봇과 플레이 할 때는 룩, 나이트, 비숍, 퀸으로 모두 프로모션 가능합니다!)</p>`,
    ...
    // =========================================
    {
        ...
        steps: [
            ...
            // 2단계: 킹 피하기 (퍼즐)
            {
                ...
                fen: 'rnb1kbnr/pppp1ppp/8/8/2B1Pp1q/8/PPPP2PP/RNBQK1NR w KQkq - 0 1', 
                description: '백 킹이 h4의 흑 퀸의 공격으로부터 안전하게 이동할 수 있는 칸(f1)으로 움직여 체크를 피하세요.',
                hint: 'F8로 이동하세요.',
                expectedMove: { from: 'e1', to: 'f1' }
            }
        ]
    },
