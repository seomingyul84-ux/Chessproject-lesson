// lessons.js 파일 내용 (expectedMove 추가 수정본)
...
const LESSON_DATA = [
    {
        ...
        steps: [
            ...
            // 3단계: 폰의 기본 행마 (전진) - 퍼즐
            {
                ...
                description: `
                    <p>폰은 처음 움직일 때 1칸 또는 2칸 전진 가능합니다. **A2 폰**을 움직여 **2칸 전진**을 시도해 보세요.</p>
                `,
            ...
            // 5단계: 나이트의 행마 - 퍼즐
            {
                ...
                description: `
                    <p>나이트는 L자 모양으로 움직입니다. D2에 있는 나이트를 **F3**으로 이동시켜 보세요.</p>
                `,
            ...
            // 6단계: 비숍의 행마 - 퍼즐
            {
                ...
                description: `
                    <p>비숍은 대각선으로 움직입니다. A1에 있는 비숍을 보드의 가장 먼 칸인 **H8**로 이동시켜 보세요.</p>
                `,
            ...
            // 7단계: 룩의 행마 - 퍼즐
            {
                ...
                description: `
                    <p>룩은 직선(가로/세로)으로 움직입니다. A1에 있는 룩을 **H1**으로 이동시켜 보세요.</p>
                `,
            ...
            // 9단계: 특수 규칙 1: 프로모션 - 퍼즐
            {
                ...
                description: `
                    <p>폰이 반대편 끝(8랭크)에 도달하면 승격(프로모션)합니다. **A7 폰**을 움직여 프로모션을 시도해 보세요.</p>
                `,
            ...
            // 11단계: 특수 규칙 3: 캐슬링 - 퍼즐
            {
                ...
                description: `
                    <p>캐슬링은 킹과 룩을 동시에 이동시켜 킹을 안전하게 하는 규칙입니다. 흰색 킹을 움직여 **킹사이드 캐슬링**을 시도해 보세요.</p>
                    <ul>
                        <li>킹사이드 캐슬링: O-O</li>
                    </ul>
                `,
